...
function updateFeedback(time) {
  ...
  document.querySelector('.progress-fill').style.strokeDashoffset = 100 * (1 - level);
  document.querySelector('.progress-hand').setAttribute('transform', 'rotate(' + level * 360 + ' 60 60)');
}
